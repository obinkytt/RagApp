...
# Support running both as a package and as a plain script
try:
...
# File upload
uploaded = st.file_uploader("Upload a PDF or DOCX", type=["pdf", "docx"], accept_multiple_files=False, key="clean_file_uploader")
...
# Chat input
prompt = st.chat_input("Ask a question about the document…", disabled=chat_disabled, key="clean_chat_input")
